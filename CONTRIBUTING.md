Contributing to Spectra Core
============================

The Spectra Core project operates an open contributor model where anyone is
...
[Translation Process](https://https://github.com/Spectra-blockchain/SPECTRA/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Spectra Core project, and is not to be
confused with overall Spectra Network Protocol consensus changes.

Whether a pull request is merged into Spectra Core rests with the project merge
...
The project leader is the release manager for each Spectra Core release.
