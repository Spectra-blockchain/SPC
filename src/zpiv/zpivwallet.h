// Copyright (c) 2017-2018 The Spectra developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Spectra_ZSPCWALLET_H
#define Spectra_ZSPCWALLET_H
...
public:
    CzSPCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSPC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSPC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
