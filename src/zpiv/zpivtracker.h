...
#ifndef Spectra_ZSPCTRACKER_H
#define Spectra_ZSPCTRACKER_H
...
public:
    CzSPCTracker(std::string strWalletFile);
    ~CzSPCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSPCWallet* zSPCWallet = NULL);
