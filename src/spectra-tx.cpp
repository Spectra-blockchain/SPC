...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Spectra Core spectra-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  spectra-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded spectra transaction") + "\n" +
                               "  spectra-tx [options] -create [commands]   " + _("Create hex-encoded spectra transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded spectra transaction
