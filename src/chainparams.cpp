...
// Copyright (c) 2015-2019 The Spectra developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000179c2edcadbffebb5d3940e6fe018d8905df41a73bbc9f6f350547ed684"));  //launch
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1656380400, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04ccaf7954bd8af6c61d4c97d324bdce5c063a36205373f271f3ba83184be9f4eff44c404e51f097dc559f9f36325d078ec655834d3278e7557130a79f55bc3895");
        nDefaultPort = 17000;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Spectra starting difficulty is 1 / 2^12
        ...
        nMaxMoneyOut = 675000000 * COIN;
        nMinColdStakingAmount = 1 * COIN;
        nDevAddress = "SN16hnRfhtzesYCZtocFo5DX9vj6GVvSRT";

        /** Height or Time Based Activations **/
        nLastPOWBlock = 1000;
        nSpectraBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nSpectraBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Central African Republic president launches crypto initiative following Bitcoin adoption - CoinTelegraph 28/06/2022";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.spectrablockchain.com"));
		vSeeds.push_back(CDNSSeedData("seed2", "seed2.spectrablockchain.com"));
		vSeeds.push_back(CDNSSeedData("seed3", "seed3.spectrablockchain.comc"));
		vSeeds.push_back(CDNSSeedData("seed4", "seed4.spectrablockchain.com"));
		vSeeds.push_back(CDNSSeedData("seed5", "seed5.spectrablockchain.com"));
		vSeeds.push_back(CDNSSeedData("seed6", "seed6.spectrablockchain.com"));
		vSeeds.push_back(CDNSSeedData("seed7", "seed7.spectrablockchain.com"));
		vSeeds.push_back(CDNSSeedData("seed8", "seed8.spectrablockchain.com"));
		vSeeds.push_back(CDNSSeedData("seed9", "seed9.spectrablockchain.com"));
		vSeeds.push_back(CDNSSeedData("seed10", "seed10.spectrablockchain.com"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0xa1)(0xf5)(0x70)(0x1a).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0xa1)(0xd4)(0x77)(0xab).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x69)(0xfd)(0xc0)(0x33).convert_to_container<std::vector<unsigned char> >();
        ...
        strSporkPubKey = "04669673cbff436f735219e828c7799c2c8c6c6fb6d0d61ea5124c591ad0873ce2a905e1fc5c433b2bc5d0970b91ef75ef7baf1f3388a445795849834190db5a33";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nSpectraBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nSpectraBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet spectra addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 135);  // Testnet spectra script addresses start with 'w'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 125);     // starting with 's'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet spectra BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet spectra BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet spectra BIP44 coin type is '1' (All coin's testnet default)
