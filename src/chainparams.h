...
public:
    ...
    int SpectraBadBlockTime() const { return nSpectraBadBlockTime; }
    int SpectraBadBlocknBits() const { return nSpectraBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nSpectraBadBlockTime;
    unsigned int nSpectraBadBlocknBits;
