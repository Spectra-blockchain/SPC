...
// Copyright (c) 2016-2019 The Spectra developers
...
/** 
    ...
    ****Note - for Spectra we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of spectra coming in to a transaction
