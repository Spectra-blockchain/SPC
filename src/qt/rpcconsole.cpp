                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSPCPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzSPCPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzSPCPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSPCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Spectra RPC console.") + "<br>" +
