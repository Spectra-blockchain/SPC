...
#include "qt/spectra/forms/ui_addresseswidget.h"
#include "qt/spectra/addresslabelrow.h"
#include "qt/spectra/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(SpectraGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter Spectra address"));
