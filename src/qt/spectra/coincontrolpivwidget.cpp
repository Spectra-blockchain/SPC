...
#include "qt/spectra/coincontrolpivwidget.h"
#include "qt/spectra/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select SPC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("SPC");
    ...
    ui->labelValueAfter->setText("0.00 SPC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 SPC");
    ui->labelValueFee->setText("0.00 SPC");
