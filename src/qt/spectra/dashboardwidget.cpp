...
#include "qt/spectra/forms/ui_dashboardwidget.h"
#include "qt/spectra/sendconfirmdialog.h"
#include "qt/spectra/txrow.h"
...
DashboardWidget::DashboardWidget(SpectraGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of SPC staked."));
    ...
    ui->labelAmountPiv->setText("0 SPC");
    ...
    ui->btnHowTo->setText(tr("How to get SPC"));
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZSPC;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair SPC, zSPC
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("SPC");
    set1 = new QBarSet("zSPC");
