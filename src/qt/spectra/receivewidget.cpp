...
#include "qt/spectra/forms/ui_receivewidget.h"
...
#include "qt/spectra/addressholder.h"
...
ReceiveWidget::ReceiveWidget(SpectraGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive SPC."));
