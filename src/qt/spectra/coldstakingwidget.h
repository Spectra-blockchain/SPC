...
#include "qt/spectra/furabstractlistitemdelegate.h"
#include "qt/spectra/txviewholder.h"
#include "qt/spectra/tooltipmenu.h"
#include "qt/spectra/sendmultirow.h"
#include "qt/spectra/coldstakingmodel.h"
#include "qt/spectra/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(SpectraGUI* parent);
    ~ColdStakingWidget();
