...
#include "qt/spectra/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/spectra/lockunlock.h"
#include "qt/spectra/qtutils.h"
#include "qt/spectra/receivedialog.h"
...
TopBar::TopBar(SpectraGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("Spectra")
    updateDisplayUnit();
