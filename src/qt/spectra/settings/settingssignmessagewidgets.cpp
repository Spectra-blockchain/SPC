...
#include "qt/spectra/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(SpectraGUI* _window, QWidget *parent) :
