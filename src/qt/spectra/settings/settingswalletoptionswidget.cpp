...
#include "qt/spectra/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/spectra/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(SpectraGUI* _window, QWidget *parent) :
