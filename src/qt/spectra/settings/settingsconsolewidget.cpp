...
#include "qt/spectra/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/spectra/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(SpectraGUI* _window, QWidget *parent) :
