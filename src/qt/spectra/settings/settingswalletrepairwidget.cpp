...
#include "qt/spectra/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/spectra/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SpectraGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SpectraGUI::handleRestart()
