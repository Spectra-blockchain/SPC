...
#include "qt/spectra/coldstakingwidget.h"
#include "qt/spectra/forms/ui_coldstakingwidget.h"
#include "qt/spectra/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/spectra/requestdialog.h"
#include "qt/spectra/tooltipmenu.h"
#include "qt/spectra/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(SpectraGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your SPCs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept SPC delegation / Delegate SPC"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select SPC outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 SPC" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
