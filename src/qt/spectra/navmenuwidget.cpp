...
#include "qt/spectra/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(SpectraGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-spectra");
