// Copyright (c) 2017-2020 The Spectra developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zSPC Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zSPC.";
            else if (!mint.isSeedCorrect)
                strReason = "The zSPC seed used to mint this zSPC is not the same as currently hold in the wallet";
            else
