...
The build script we'll be using is contained in the Spectra github repository ([contrib/gitian-build.py](https://https://github.com/Spectra-blockchain/SPECTRA/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Spectra repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/spectra-spectra/Spectra/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, spectra-detached-sigs, and spectra GitHub repos.
