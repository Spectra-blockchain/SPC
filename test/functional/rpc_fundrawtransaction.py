...
class RawTransactionsTest(SpectraTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid spectra address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid spectra address" in e.error['message'])
