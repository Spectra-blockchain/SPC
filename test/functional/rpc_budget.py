...
class BudgetProposalTest(SpectraTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 SPC allowed", self.nodes[0].preparebudget,
