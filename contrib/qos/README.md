...
This means one can have an always-on spectrad instance running, and another local spectrad/spectra-qt instance which connects to this node and receives blocks from it.
