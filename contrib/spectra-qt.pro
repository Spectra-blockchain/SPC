...
RESOURCES += src/qt/spectra.qrc src/qt/spectra_locale.qrc

TRANSLATIONS += src/qt/locale/spectra_bg.ts \
                src/qt/locale/spectra_de.ts \
                src/qt/locale/spectra_en.ts \
                src/qt/locale/spectra_es.ts \
                src/qt/locale/spectra_fi.ts \
                src/qt/locale/spectra_fr.ts \
                src/qt/locale/spectra_it.ts \
                src/qt/locale/spectra_ja.ts \
                src/qt/locale/spectra_pl.ts \
                src/qt/locale/spectra_pt.ts \
                src/qt/locale/spectra_ru.ts \
                src/qt/locale/spectra_sk.ts \
                src/qt/locale/spectra_sv.ts \
                src/qt/locale/spectra_vi.ts \
                src/qt/locale/spectra_zh_CN.ts \
                src/qt/locale/spectra_zh_TW.ts
